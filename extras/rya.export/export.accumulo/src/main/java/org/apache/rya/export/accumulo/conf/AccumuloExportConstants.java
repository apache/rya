...
public class AccumuloExportConstants {
    ...
    public static final ImmutableMap<String, List<String>> DUPLICATE_KEY_MAP = ImmutableMap.<String, List<String>>builder()
        ...
        .put(MRUtils.TABLE_PREFIX_PROPERTY, ImmutableList.of(ConfigUtils.CLOUDBASE_TBL_PREFIX, RdfTripleStoreConfiguration.CONF_TBL_PREFIX))
        ...
        .put(MRUtils.TABLE_PREFIX_PROPERTY + CHILD_SUFFIX, ImmutableList.of(ConfigUtils.CLOUDBASE_TBL_PREFIX + CHILD_SUFFIX, RdfTripleStoreConfiguration.CONF_TBL_PREFIX + CHILD_SUFFIX))
        .build();
