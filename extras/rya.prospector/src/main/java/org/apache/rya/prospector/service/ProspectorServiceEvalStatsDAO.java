...
public class ProspectorServiceEvalStatsDAO implements RdfEvalStatsDAO<RdfCloudTripleStoreConfiguration> {
    ...
    public double getCardinality(RdfCloudTripleStoreConfiguration conf, CARDINALITY_OF card, List<Value> val) throws RdfDAOException {
        ...
        switch (card) {
            case SUBJECT:
                triplePart = TripleValueType.subject.toString();
                break;
            case PREDICATE:
                triplePart = TripleValueType.predicate.toString();
                break;
            case OBJECT:
                triplePart = TripleValueType.object.toString();
                break;
            case SUBJECTPREDICATE:
                triplePart = TripleValueType.subjectpredicate.toString();
                break;
            case SUBJECTOBJECT:
                triplePart = TripleValueType.subjectobject.toString();
                break;
            case PREDICATEOBJECT:
                triplePart = TripleValueType.predicateobject.toString();
                break;
        }
