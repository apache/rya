...
/**
 * select Geo,tempo    result: no tempo
 * select Geo,tempo    result: yes tempo
 * select Geo,no tempo result: no tempo
 * select Geo,no tempo result: yes tempo
 * select no Geo,tempo result: no tempo
