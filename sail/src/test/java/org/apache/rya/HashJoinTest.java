...
public class HashJoinTest {
    ...
    public void testSimpleJoin() throws Exception {
        ...
        //1 join
        HashJoin<AccumuloRdfConfiguration> hjoin = new HashJoin<>(dao.getQueryEngine());
        CloseableIteration<RyaResource, RyaDAOException> join = hjoin.join(conf,
    ...
    public void testSimpleJoinMultiWay() throws Exception {
        ...
        CloseableIteration<RyaIRI, RyaDAOException> join = hjoin.join(conf,
                new RdfCloudTripleStoreUtils.CustomEntry<>(pred, one),
                new RdfCloudTripleStoreUtils.CustomEntry<>(pred, two),
    ...
    public void testSimpleHashJoinPredicateOnly() throws Exception {
        ...
        //1 join
        HashJoin<AccumuloRdfConfiguration> ijoin = new HashJoin<>(dao.getQueryEngine());
