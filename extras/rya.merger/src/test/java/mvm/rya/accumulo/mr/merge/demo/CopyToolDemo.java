...
public class CopyToolDemo {
    ...
    private void copyToolRun(Date startDate) throws AccumuloException, AccumuloSecurityException {
        ...
        copyTool.setupAndRun(new String[] {
                ...
                makeArgument(CopyTool.COPY_TABLE_LIST_PROP, PARENT_TABLE_PREFIX + RdfCloudTripleStoreConstants.TBL_SPO_SUFFIX),
                ...
                makeArgument(CopyTool.COPY_FILE_IMPORT_DIRECTORY, "/test/copy_tool_file_output/"),
                makeArgument(CopyTool.USE_COPY_FILE_IMPORT, Boolean.toString(false)),
