...
/**
 * Interface for things that can sort triples (for optimizing queries).
 */
public interface TripleSorter {
    /**
     * Sort the array triples and return the reorganized array. A new array may be returned
     * or the existing array reorganized in-place. The result array may have a different
    ...
    public static final TripleSorter dontSort = new TripleSorter() {
        @Override
        public Triple[] sort(final Triple[] triples) {
            return triples;
        }
    };
}