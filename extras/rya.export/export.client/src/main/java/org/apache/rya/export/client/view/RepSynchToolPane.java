...
import org.apache.rya.export.client.view.LogPane.ResizeListener;

/**
 * Displays the configuration and logging during a merge.
 */
public class RepSynchToolPane extends JPanel {
    ...
    /**
     * Constructs a new {@link RepSynchToolPane}.
     *
     ...
     */
    public RepSynchToolPane(final RyaStatementStore sourceStore, final RyaStatementStore destStore, final String ryaInstanceName,
    ...
    private void runMerger(final Date dateTime) {
        ...
        final StatementListener listen = new StatementListener() {
            ...
            public void notifyAddStatement(final RyaStatementStore store, final RyaStatement statement) {
                SwingUtilities.invokeLater(() -> logPane.addLog(
                        String.format("Adding: %s, %s, %s",
                                statement.getSubject().getData(),
    ...
    public void addResizeListener(final ResizeListener listen) {
        ...
        logPane.addResizeListener(listen);
    }
    ...
    public void removeResizeListener(final ResizeListener listen) {
        requireNonNull(listen);
        logPane.removeResizeListener(listen);
    }
}
