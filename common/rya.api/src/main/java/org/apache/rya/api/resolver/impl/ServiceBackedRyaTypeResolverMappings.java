...
public class ServiceBackedRyaTypeResolverMappings {
    ...
    public List<RyaTypeResolverMapping> getResolvers() {
        ServiceLoader<RyaTypeResolver> loader = ServiceLoader.load(RyaTypeResolver.class);
        List<RyaTypeResolverMapping> resolvers = new ArrayList<RyaTypeResolverMapping>();
