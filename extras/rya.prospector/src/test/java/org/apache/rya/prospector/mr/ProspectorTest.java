...
public class ProspectorTest {
    ...
    public void testCount() throws Exception {
        ...
        final List<IndexEntry> entityEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.entity.name(), queryTerms, XMLSchema.ANYURI.stringValue(), auths);
        ...
        final List<IndexEntry> expectedEntityEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setTripleValueType( TripleValueType.entity.toString() )
                    .setVisibility("")
        ...
        final List<IndexEntry> subjectEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.subject.name(), queryTerms, XMLSchema.ANYURI.stringValue(), auths);
        ...
        final List<IndexEntry> expectedSubjectEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setDataType(XMLSchema.ANYURI.stringValue())
                    .setTripleValueType( TripleValueType.subject.toString() )
                    .setVisibility("")
                    .setTimestamp(prospectTimestamp)
                    .setCount(new Long(3))
                    .build());
        ...
        final List<IndexEntry> predicateEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.predicate.name(), queryTerms, XMLSchema.ANYURI.stringValue(), auths);
        ...
        final List<IndexEntry> expectedPredicateEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setDataType(XMLSchema.ANYURI.stringValue())
                    .setTripleValueType( TripleValueType.predicate.toString() )
                    .setVisibility("")
                    .setTimestamp(prospectTimestamp)
                    .setCount(new Long(4))
                    .build());
        ...
        final List<IndexEntry> objectEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.object.name(), queryTerms, XMLSchema.STRING.stringValue(), auths);
        ...
        final List<IndexEntry> expectedObjectEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setTripleValueType( TripleValueType.object.toString() )
                    .setVisibility("")
                    .setTimestamp(prospectTimestamp)
                    .setCount(new Long(1))
                    .build());
        ...
        queryTerms.add("urn:gem:etype#1234");
        queryTerms.add("urn:gem#pred");
        final List<IndexEntry> subjectPredicateEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.subjectpredicate.name(), queryTerms, XMLSchema.STRING.stringValue(), auths);
        ...
        final List<IndexEntry> expectedSubjectPredicateEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setDataType(XMLSchema.STRING.stringValue())
                    .setTripleValueType( TripleValueType.subjectpredicate.toString() )
                    .setVisibility("")
                    .setTimestamp(prospectTimestamp)
                    .setCount(new Long(3))
                    .build());
        ...
        queryTerms.add("urn:gem#pred");
        queryTerms.add("12");
        final List<IndexEntry> predicateObjectEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.predicateobject.name(), queryTerms, XMLSchema.STRING.stringValue(), auths);
        ...
        final List<IndexEntry> expectedPredicateObjectEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setDataType(XMLSchema.STRING.stringValue())
                    .setTripleValueType( TripleValueType.predicateobject.toString() )
                    .setVisibility("")
                    .setTimestamp(prospectTimestamp)
        ...
        queryTerms.add("urn:gem:etype#1234");
        queryTerms.add("mydata1");
        final List<IndexEntry> subjectObjectEntries = service.query(plist, ProspectorConstants.COUNT, TripleValueType.subjectobject.name(), queryTerms, XMLSchema.STRING.stringValue(), auths);
        ...
        final List<IndexEntry> expectedSubjectObjectEntries = Lists.newArrayList(
                IndexEntry.builder()
                    ...
                    .setDataType(XMLSchema.STRING.stringValue())
                    .setTripleValueType( TripleValueType.subjectobject.toString() )
                    .setVisibility("")
                    .setTimestamp(prospectTimestamp)
                    .setCount(new Long(1))
                    .build());
