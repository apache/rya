...
import org.apache.rya.export.client.view.MergeToolPane;
...
public class RepSynchDriver {
    ...
    public static void main(final String[] args) throws MergeConfigurationException, ParseException {
        ...
        try {
            ...
            frame.setContentPane(new MergeToolPane(parentStore, childStore, configuration.getParent().getRyaInstanceName(), timeOffset));
