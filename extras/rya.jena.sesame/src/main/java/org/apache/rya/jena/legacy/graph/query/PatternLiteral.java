...
/**
 * PatternLiteral - an interface for pattern literals recognized by Rewrite.
...
public interface PatternLiteral {
    ...
    /**
     * @return the pattern modifiers (a string of characters) of this pattern.
    ...
    /**
     * @return the language of the pattern. The only name recognized at this
